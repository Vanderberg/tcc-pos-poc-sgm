...
namespace SGM.Cidadao.CrossCutting.DependencyInjection
{
    public class ConfigureSeed
    {
        ...
        public void Seed()
        {
            Guid? PoliticaID = new Guid();
            Guid? CampanhaID = new Guid();
            Guid? PoliticaID2 = new Guid();
            Guid? CampanhaID2 = new Guid();
            ...
            {
                VotacaoEntity v1 = new VotacaoEntity {Id = Guid.NewGuid(), CreateAt = DateTime.UtcNow, Votos = 0, PoliticaPublicaID = PoliticaID.Value, CampanhaID = CampanhaID.Value};
                VotacaoEntity v2 = new VotacaoEntity {Id = Guid.NewGuid(), CreateAt = DateTime.UtcNow, Votos = 0, PoliticaPublicaID = PoliticaID2.Value, CampanhaID = CampanhaID2.Value};
